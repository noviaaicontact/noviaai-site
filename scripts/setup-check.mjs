...
const checks = [
  ...
  ['Stripe price Pro (199$)', !!process.env.STRIPE_PRICE_PRO, 'npm run stripe:bootstrap'],
...
else if (!process.env.STRIPE_PRICE_PRO) console.log('  2. npm run stripe:bootstrap  puis configurer webhook (stripe listen)');

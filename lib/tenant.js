...
async function resolveClient(twilioNumber) {
  ...
  if (raw) {
    // Toujours construire le dossier : un abonnement inactif ne doit pas
    // couper l'agent SMS (texto direct au numéro). Le flag suspended reste
    // utile pour bloquer le provisioning / certaines actions billing.

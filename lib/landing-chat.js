...
PRIX (CAD / mois)
- Essentiel : 149 $/mois — 100 conversations/mois. Petites entreprises, faible volume.
- Croissance : 299 $/mois — 300 conversations/mois. Volume régulier. Forfait recommandé.
- Pro : 499 $/mois — 1 000 conversations/mois. Volume élevé.
...
function fallbackReply(message) {
  ...
  if (/prix|tarif|combien|co[uû]t|\$|149|299|499|forfait/.test(t)) {
    return 'Trois forfaits CAD/mois : Essentiel 149 $ (100 conversations), Croissance 299 $ (300 — recommandé), Pro 499 $ (1 000). Essai 14 jours, sans contrat. Inscription : /signup.html?plan=croissance';
  }
  ...
  if (/essai|gratuit|14/.test(t)) {
    return 'Essai 14 jours : carte requise pour activer la ligne, premier prélèvement après l\'essai. On mesure vos conversations pour recommander le bon forfait. Annulation en un clic. Inscription : /signup.html?plan=croissance';
  }

...
- Widget chatbot pour le site web du commerçant (inclus).
- Alertes leads par courriel (demandes de RDV à confirmer — pas de sync agenda).

PRIX
- Forfait Pro unique : 199 $/mois (prix fondateur), essai gratuit 14 jours, sans contrat annuel.
- Après l'essai : carte requise pour activer la ligne; premier prélèvement après 14 jours.
- Annulation en un clic via portail Stripe.

MISE EN SERVICE
- Inscription ~2–5 min : courriel, config commerce, ajout carte → ligne activée automatiquement (~1–2 min).
...
function fallbackReply(message) {
  ...
  if (/essai|gratuit|14/.test(t)) {
    return 'Oui — 14 jours d\'essai gratuit. Vous ajoutez votre carte pour activer la ligne, mais le premier prélèvement est après l\'essai. Annulation en un clic.';
  }

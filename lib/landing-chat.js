...
PRIX (CAD / mois)
- Essentiel : 149 $/mois — 50 conversations/mois. Idéal pour 10–40 appels manqués / mois. Inclut widget web + avis Google. SEUL forfait avec essai 14 jours.
- Croissance : 299 $/mois — 200 conversations/mois. Commerces actifs (~150 appels manqués). S'active au paiement (après l'essai Essentiel).
- Pro : 499 $/mois — 750 conversations/mois. Haut volume / multi-lignes. S'active au paiement.
- Une conversation = un prospect distinct qui échange avec NoviaAI.
- Essai 14 jours UNIQUEMENT sur Essentiel, sans carte, sans contrat annuel.
- Pendant l'essai on mesure l'usage pour recommander Essentiel, Croissance ou Pro à l'activation.
- Garantie 30 jours : si aucun client n'est rattrapé dans les 30 premiers jours payants, remboursement sur demande.
- Aucune carte requise pour démarrer. Essai Essentiel 14 jours, puis paiement pour continuer (sinon les fonctions se mettent en pause).
...
function fallbackReply(message) {
  ...
  if (/prix|tarif|combien|co[uû]t|\$|149|299|499|forfait/.test(t)) {
    return 'Trois forfaits CAD/mois : Essentiel 149 $ (50 conv., essai 14 j), Croissance 299 $ (200), Pro 499 $ (750). L\'essai gratuit est sur Essentiel seulement. Inscription : /signup.html?plan=essentiel';
  }
  if (/garantie|rembours/.test(t)) {
    return 'Garantie 30 jours : si aucun client n\'est rattrapé dans les 30 premiers jours payants, on rembourse sur demande. Essai Essentiel 14 jours avant ça. Inscription : /signup.html?plan=essentiel';
  }
  if (/essai|gratuit|14/.test(t)) {
    return 'Essai 14 jours sur Essentiel seulement : aucune carte. Testez avec votre vraie ligne ; après, activez Essentiel, Croissance ou Pro. Inscription : /signup.html?plan=essentiel';
  }
  ...
  if (/d[eé]mo|essayer|voir/.test(t)) {
    return 'Vous pouvez voir une démo interactive ici : /dashboard.html?demo=1 — ou démarrer votre essai Essentiel : /signup.html?plan=essentiel';
  }
  ...
  return 'Bonne question! NoviaAI aide les commerces à ne plus perdre les clients qui appellent — SMS auto après appel manqué, inbox et agent IA. Essai Essentiel 14 jours : /signup.html?plan=essentiel — Démo : /dashboard.html?demo=1';
}

...
const MAX_SLOTS = 14;
const SCHEDULING_RE = /rendez-vous|rendez vous|rdv|réserver|reserver|reservation|réservation|disponib|horaire|plage|créneau|creneau|demain|aujourd|lundi|mardi|mercredi|jeudi|vendredi|samedi|dimanche|\d{1,2}\s*h\b|\d{1,2}:\d{2}/i;

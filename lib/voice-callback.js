...
/** En dessous : répondeur magasin / message vocal. Au-dessus : vraie conversation. */
const HUMAN_ANSWER_MIN_SEC = 90;

/**
 * Déclencher le SMS de rattrapage ?
 * - no-answer / busy / failed / canceled : classique
 * - completed sans pont : pas de vraie conversation
 * - completed court : leur répondeur « décroche » — on texto quand même
 */
function shouldSendTextback(dialStatus, dialDuration, dialBridged) {
  ...
  return seconds < HUMAN_ANSWER_MIN_SEC;
}

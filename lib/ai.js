...
POLITIQUES
${policies || '(aucune)'}${instructionsBlock}
...
2. Cherche la réponse dans cet ordre : FAQ → SERVICES → HORAIRES → POLITIQUES → INSTRUCTIONS PERSONNALISÉES → coordonnées/liens → EXTRAITS PERTINENTS (site/documents indexés).

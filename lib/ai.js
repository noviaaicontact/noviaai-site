...
function buildSystemPrompt(dossier) {
  ...
  const phoneLine = phonePublic
    ? `Téléphone (à donner au client si demandé): ${phonePublic}`
    : 'Téléphone: non configuré — ne pas inventer de numéro; propose un rappel.';

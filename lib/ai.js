...
function buildSystemPrompt(dossier, opts = {}) {
  ...
  return `Tu es ${agent.nom_agent || 'Léa'}, ${roleLabel} de ${biz.nom_court || 'ce commerce'}.
${agent.role || ''}
...
${calendarLive
    ? '- Calendrier CONNECTÉ. Si on te demande si tu as accès à Google Calendar / l\'agenda : OUI. Propose UNIQUEMENT les plages de AGENDA RÉEL. Si le client en choisit une, confirme jour et heure. N\'invente aucune autre heure.'

...
const PROVIDER_TIPS = {
  bell: {
    ...
    iphoneSteps: [
      'Appelez Bell au 1-800-667-0123 (ou *611) et demandez un <strong>renvoi d’appel</strong>.',
      'Précisez : renvoi d’appel <em>si je ne réponds pas</em> (non-réponse) vers {{NUM}} — le téléphone sonne d’abord.',
      'Confirmez que ce n’est PAS un renvoi permanent / tous les appels.',
    ...
    androidSteps: [
      ...
      'Sinon appelez Bell au 1-800-667-0123 et demandez un <strong>renvoi d’appel</strong> sur non-réponse vers {{NUM}}.',
    ],
  },
  videotron: {
    label: 'Vidéotron',
    support: '1-877-380-2611',
    iphone: 'Appelez Vidéotron pour demander un renvoi d’appel — n’activez pas le toggle Renvoi dans Réglages iPhone (permanent).',
    ...
    iphoneSteps: [
      'Appelez Vidéotron au 1-877-380-2611 et demandez un <strong>renvoi d’appel</strong>.',
      'Précisez : renvoi d’appel sur non-réponse vers {{NUM}} (pas permanent).',
    ...
    androidSteps: [
      ...
      'Sinon : soutien Vidéotron 1-877-380-2611 — demandez un <strong>renvoi d’appel</strong> sur non-réponse vers {{NUM}}.',
    ],
  },
  rogers: {
  ...
  fizz: {
    ...
    iphoneSteps: [
      'Ouvrez le clavardage Fizz (ou soutien Public Mobile) et demandez un <strong>renvoi d’appel</strong>.',
      'Précisez : renvoi d’appel si pas de réponse vers {{NUM}}.',
      'Si impossible : basculez sur « Nouveau numéro NoviaAI » (recommandé).',
    ],
    androidSteps: [
      'Essayez Paramètres → Renvoi d’appel → Si non répondu → {{NUM}}.',
      'Sinon contactez le soutien Fizz / Public Mobile et demandez un <strong>renvoi d’appel</strong> sur non-réponse vers {{NUM}}.',
  ...
  freedom: {
    ...
    iphone: 'Réglages → Téléphone → Renvoi d’appel → Si non répondu, ou appelez Freedom pour demander un renvoi d’appel.',
    android: 'Paramètres → Renvoi d’appel → Si non répondu → numéro NoviaAI.',
    callProvider: true,
    note: 'Si le menu iPhone est limité, appelez Freedom pour un renvoi d’appel conditionnel.',
    iphoneSteps: [
      'Réglages → Téléphone → Renvoi d’appel → Si non répondu → {{NUM}}.',
      'Sinon : 1-877-946-3184 — demandez un <strong>renvoi d’appel</strong> sur non-réponse vers {{NUM}}.',
    ],
    androidSteps: [
      'Paramètres → Renvoi d’appel → Si non répondu → {{NUM}}.',
      'Testez ; sinon appelez Freedom et demandez un <strong>renvoi d’appel</strong> sur non-réponse vers {{NUM}}.',
    ],
  },
  other_mobile: {
    label: 'Autre',
    support: 'Service à la clientèle de votre opérateur',
    iphone: 'Réglages → Téléphone → Renvoi si non répondu, ou appelez votre fournisseur pour un renvoi d’appel.',
    android: 'Paramètres → Renvoi d’appel → Si non répondu → numéro NoviaAI.',
    callProvider: true,
    note: 'Demandez toujours un « renvoi d’appel si pas de réponse » — jamais permanent.',
    iphoneSteps: [
      'Réglages → Téléphone → Renvoi d’appel → Si non répondu → {{NUM}}.',
      'Sinon appelez votre fournisseur et demandez un <strong>renvoi d’appel</strong> (si je ne réponds pas) vers {{NUM}}.',
    ],
    androidSteps: [
      'Paramètres → Renvoi d’appel → Si non répondu → {{NUM}}.',
      'Sinon : soutien de votre opérateur — demandez un <strong>renvoi d’appel</strong> sur non-réponse vers {{NUM}}.',
    ],
  },
};
